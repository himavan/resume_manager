   ...
   <div class="mdl-cell--12-col">
    ...
    <thead>
        <tr>
            ...
            <th>Job Salary(&#8377;)</th>
            <th class="mdl-data-table__cell--non-numeric">Apply</th>
        </tr>
    </thead>
    <tbody>
    <?php
    ...
    ?>
       ...
       <tr>
            ...
            <td class="mdl-data-table__cell--non-numeric"><a class="mdl-button mdl-button--raised mdl-button--primary" href="app_edit.php?jobid=<?php echo $row[0]; ?>">Apply </a></td>
