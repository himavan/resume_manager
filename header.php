...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
          ...
          <a class="mdl-navigation__link" href="create_resume.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>Create Resume</a>
          <a class="mdl-navigation__link" href="apply_jobs.php"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">queue</i>Apply Jobs</a>
		      <a class="mdl-navigation__link" href="settings.php?page=home"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">settings_applications</i>Settings</a>
